...
import { RelatorioAtividadeaMatriculadosService } from './matriculados.service';
...
@Component({
	selector: 'app-relatorio-atividades-matriculados',
	standalone: true,
	...
	styleUrl: './matriculados.component.css',  
	providers: [provideNgxMask(), RelatorioAtividadeaMatriculadosService, AssociadosService, DecimalPipe ]
})


export class RelatorioAtividadesMatriculadosComponent implements OnInit{
	...
	constructor(
		public service: RelatorioAtividadeaMatriculadosService, 
