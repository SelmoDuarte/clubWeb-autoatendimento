...
export class RelatorioAtividadeaMatriculadosService extends Service {

	constructor( private pipe: DecimalPipe,  private http: HttpClient) {
		super();
	}

	private readonly API_RELATORIOS = Funcoes.getPathBackEnd() + '/api/relatorios/atividade/matriculados';
