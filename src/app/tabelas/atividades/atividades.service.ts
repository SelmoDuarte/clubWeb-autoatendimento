...
export class AtividadeService {
	...
	private readonly API_CONTROLLER = Funcoes.getPathBackEnd() + '/clubWeb-api/ascclub/atividadeController.php';
	...
	getTurmas(atividade_id: string) {
		return this.http.post(this.API_CONTROLLER, {"operacao": "GET_TURMAS", 'atividade_id': atividade_id}, this.httpOptions)
	}
	...
	getCombos() {
		return this.http.post(this.API_CONTROLLER, {"operacao": "GET_COMBOS_ATIVIDADES"}, this.httpOptions)
	}	

	getDetalhes(atividade_id: string) {
		return this.http.post(this.API_CONTROLLER, {"operacao": "GET_DETALHES", "atividade_id": atividade_id }, this.httpOptions)
	}
